import {
  ...
  Link,
  useNavigate
} from "./chunk-PSJX2AGZ.js";
import {
  AppProvider
} from "./chunk-OR62V6DL.js";
import "./chunk-X6ECF75N.js";
import {
  require_jsx_runtime
} from "./chunk-4UGQLU7J.js";
import "./chunk-GG7KP6KM.js";
import "./chunk-LTNQZFDK.js";
import {
  require_react
...
function AppProvider2(props) {
  ...
  (0, import_react4.useEffect)(() => {
    const handleNavigate = (event) => {
      var _a;
      const href = (_a = event.target) == null ? void 0 : _a.getAttribute("href");
      if (href) {
        navigate(href);
      }
    };
...
function AppProxyProvider(props) {
  ...
  const [requestUrl, setRequestUrl] = (0, import_react5.useState)();
  (0, import_react5.useEffect)(() => setRequestUrl(new URL(window.location.href)), [setRequestUrl]);
...
function AppProxyLink(props) {
  const context = (0, import_react8.useContext)(AppProxyProviderContext);
  if (!context) {
